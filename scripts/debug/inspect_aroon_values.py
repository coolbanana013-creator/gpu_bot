#!/usr/bin/env python3
# Moved debug inspector for Aroon; updated ROOT to refer to repo root
import sys
...
if __name__ == '__main__':
    ...
    print('Total mismatches:', len(diff_indices))
    if len(diff_indices) > 0:
        for idx in diff_indices[:20]:
            print(idx, 'gpu', gpu_aroon[idx], 'cpu', cpu_aroon[idx], 'diff', abs(gpu_aroon[idx] - cpu_aroon[idx]))
