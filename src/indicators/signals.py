...
def calculate_consensus_signal(signals: list, threshold: float = 1.0) -> SignalType:
    """
    Calculate consensus signal from multiple indicator signals.
    
    Args:
        signals: List of SignalType values
        threshold: Percentage of indicators that must agree (0.0-1.0), default 1.0 = 100% unanimous
