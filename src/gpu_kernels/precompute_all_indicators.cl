...
// MACD (1 indicator: 26 - MACD line)
void compute_macd(__global OHLCVBar *ohlcv, int num_bars, int fast, int slow, int signal, __global float *out) {
